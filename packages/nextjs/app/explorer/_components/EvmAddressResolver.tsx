...
type EvmAddressResolverProps = {
  baseUrl?: string;
};

export const EvmAddressResolver = ({ baseUrl }: EvmAddressResolverProps) => {
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    try {
      const address = await getEvmAddressFromNpub(value, { signal: controller.signal, baseUrl });
        ...
        {!errorMessage && !isLoading && resolvedAddress && (
          <div className="card bg-base-200">
            <div className="card-body p-4">
              <span className="text-sm mb-1">Resolved Address</span>
